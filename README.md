...
```bash
git clone https://github.com/your-org/hirepilot-ai.git
cd hirepilot-ai
```
...
*Built for the **Gappy AI National Hackathon***

[Live Frontend Demo](https://hirepilot-ai-two.vercel.app/) · [Backend API](https://hirepilot-ai-d4ak.onrender.com/)
